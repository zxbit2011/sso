...
(function (global, factory) {
    ...
    Validator.prototype._getFieldDisplayName = function _getFieldDisplayName (field) {
        return field.displayName || field.el.getAttribute("displayName") || this.dictionary.getAttribute(LOCALE, field.name, field.name);
    };
    ...
    Validator.prototype.attach = function attach (field) {
        // deprecate: handler old signature.
        if (arguments.length > 1) {
            field = assign({}, {
                name: arguments[0],
                rules: arguments[1]
